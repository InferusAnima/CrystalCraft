...
public class MCreatorCreativeChamber extends crystalcraft.ModElement {
	...
	@GameRegistry.ObjectHolder("crystalcraft:creativechamber")
	public static final Block block = null;

	public MCreatorCreativeChamber(crystalcraft instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("crystalcraft:creativechamber",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setRegistryName("creativechamber");
			setUnlocalizedName("creativechamber");
