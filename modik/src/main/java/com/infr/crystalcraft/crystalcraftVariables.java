...
public class crystalcraftVariables {

	public static class MapVariables extends WorldSavedData {

		private static final String DATA_NAME = "crystalcraft_mapvars";
	...
	public static class WorldVariables extends WorldSavedData {
		...
		private static final String DATA_NAME = "crystalcraft_worldvars";
